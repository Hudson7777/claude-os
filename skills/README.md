...
| [evening-brief](./evening-brief/) | Daily evening recap: news, deep dive, knowledge boost | 🔧 configure | [screenshot](../assets/screenshots/evening-brief.png) |
...
| [wechat-article-save](./wechat-article-save/) | Auto-saves WeChat articles on URL paste | ⚡ plug-in | — |

## Install levels

- **⚡ plug-in** — copy directory to `~/.claude/skills/`, works immediately
- **🔧 configure** — copy directory, fill in config files or set env vars
- **📐 template** — copy directory, configure `config/*.md` with your own context
